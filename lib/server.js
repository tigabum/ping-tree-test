...
// create a target and get all targets routes
router.set('/api/targets', { POST: api.createTarget, GET: api.getTargets })
// get a target by id and update a target by id routes
router.set('/api/target/:id', { GET: api.getSingleTarget, POST: api.updateTarget })
// post a request with information about the visitor route
